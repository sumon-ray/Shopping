                ...
                <div className="hero-content gap-14 flex-col lg:flex-row-reverse">
                    ...
                    <div className="w-full outline-double max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                        ...
                        <form onSubmit={handleSubmit} noValidate className="space-y-6">
                            <div className="space-y-1 text-sm">
                                ...
                                <input
                                    ...
                                    value={product.email}
                                    className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-lime-600"
                                />
                            </div>
                            <div className="space-y-1 text-sm">
                            ...
                            <button type="submit" className="btn btn-outline block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-lime-600">
                                Sign in
                            </button>
                        </form>
                        ...
                        <div className="flex justify-center space-x-4">
                            <button onClick={handleClick} aria-label="Log in with Google" className="p-3 rounded-sm">
                        ...
                        <p className="text-xs text-center sm:px-6 dark:text-gray-600">
                            ...
                            <NavLink to='/registration' className="underline dark:text-blue-500 text-blue-400">
                                Sign up
                            </NavLink>
                        </p>
                    </div>
